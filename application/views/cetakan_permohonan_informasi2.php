...
FROM inbox_permohonan_informasi ;")->row_array();
...
<table width="100%">
    ...
    <br>
    <tr>
        <td style="text-align: center">Nomor Pendaftaran*: </td>
...
<table width="100%">
    ...
    <tr>
        ...
        <td style="vertical-align: middle">
            <img src="http://cdn.onlinewebfonts.com/svg/img_291170.png" style="width: 13px;margin: 0px 1px auto 4px;"> 1. Melihat/membaca/mendengarkan/mencatat<br>
            <img src="http://cdn.onlinewebfonts.com/svg/img_291170.png" style="width: 13px;margin: 0px 1px auto 4px;"> 2. Mendapatkan salinan informasi (hardcopy/softcopy)
    ...
    <tr>
        ...
        <td colspan="2">:</td>
        <td>
             <img src="http://cdn.onlinewebfonts.com/svg/img_291170.png" style="width: 13px;margin: 0px 1px auto 4px;"> 1. Mengambil Langsung <br>
             <img src="http://cdn.onlinewebfonts.com/svg/img_291170.png" style="width: 13px;margin: 0px 1px auto 4px;"> 2. Email <br>
             <img src="http://cdn.onlinewebfonts.com/svg/img_291170.png" style="width: 13px;margin: 0px 1px auto 4px;"> 3. Kurir/POS
...
<table width="100%" style="padding-top: 10px">
    <tr>
        ...
        <td style="text-align: center"><b>Pemohon Informasi</b></td>
    </tr>
    <tr>
        <td><br><br><br><br></td>
    </tr>
