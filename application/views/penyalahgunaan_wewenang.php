...
<?php
$jml= $this->db->query("SELECT COUNT(nama) jml FROM inbox_penyalahgunaan")->row('jml');
$nomor = $this->db->query("SELECT LPAD(MAX(LEFT(noreg,3)+1),3,0) nomor FROM inbox_penyalahgunaan")->row('nomor');
$bulan = date('m');
$thn = date('Y');
            ...
            <div class="col-sm-12">
                <table width="100%" >
                   ...
                   <tr height="20" style='height:15.00pt;'>
                    ...
                    <td ><div class="bs-wizard-info text-center">
                          Dalam 5 hari, instansi akan menindaklanjuti dan akan menghubungi anda untuk meminta keterangan lanjutan jika dibutuhkan
                      </div></td>
                    <!--<td ><div class="bs-wizard-info text-center">-->
        ...
        <div class="row" style="padding-left:300px">
            <div class="col-lg-8 col-md-8 col-8 " >
                ...
                <div class="contact-form-area m-top-30" >
                    <h4>FORM PENYALAHGUNAAN WEWENANG</h4>
                    <form class="form" id="form" method="post" action="<?=base_url('admin/penyalahgunaan_wewenang/add');?>" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" name="noreg" id="noreg" value="<?=$nomor.'/Penyalahgunaan-Wewenang/'.bulanRom($bulan).'/'.$thn;?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-6 col-12">
                                <div class="form-group">
                                
                                    <input type="text" name="nama" id="nama" placeholder="Nama Pelapor" minlength="4" required>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-6 col-12">
                                <div class="form-group">
                                    <input type="text" name="unitkerja" id="unitkerja" placeholder="Unit Kerja Terlapor" maxlength="100" required>&nbsp;<span id="errmsg2"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group textarea">
