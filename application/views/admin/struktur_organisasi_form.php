    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>struktur_organisasi Form</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                ...
                ?>
              <!-- form start -->
              <form id="form" action="<?php echo base_url('admin/struktur_organisasi/'.$link) ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-sm-10" id="post_type" name="post_type" readonly value="struktur_organisasi">
                  </div>
                  <!-- ardi -->
