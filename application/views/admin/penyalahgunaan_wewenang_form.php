    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Penyalahgunaan Wewenang Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/welcome') ?>">Home</a></li>
              <li class="breadcrumb-item active">Penyalahgunaan Wewenang</li>
              <li class="breadcrumb-item active">Penyalahgunaan Wewenang Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Input Penyalahgunaan Wewenang</h3>
              </div>
              <!-- /.card-header -->
                <?php
                    $link="";
                ...
                ?>
              <!-- form start -->
              <form id="form" action="<?php echo base_url('admin/penyalahgunaan_wewenang/'.$link) ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-sm-10" id="post_type" name="post_type" readonly value="penyalahgunaan_wewenang">
                  </div>
                  <!-- ardi -->
