        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Kinerja Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Input Kinerja</h3>
              </div>
              <!-- /.card-header -->
                <?php
                    $link="";
                ...
                ?>
              <!-- form start -->
              <form id="form" action="<?php echo base_url('admin/kinerja/'.$link) ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-sm-10" id="post_type" name="post_type" readonly value="kinerja">
                  </div>
                  <!-- ardi -->
