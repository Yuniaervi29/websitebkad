            ...
            <div class="card card-primary">
              ...
              <form id="form" action="<?php echo base_url('admin/download/'.$link) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-sm-10 selectpicker" name="category_id" data-live-search="true">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-sm-10" name="post_title" id="post_title" placeholder="Title" value="<?php echo $EDIT['title'] ?>">
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                  <label for="file" class="col-sm-2 col-form-label d-flex justify-content-end" style="padding-right: 20px;">Status</label>
                  <select class="form-control col-sm-2 selectpicker" name="posting" data-live-search="true">
                  ...
                  <div class="form-group row">
                  <label for="file" class="col-sm-2 col-form-label d-flex justify-content-end" style="padding-right: 20px;">Jenis Informasi</label>
                  <select class="form-control col-sm-4 selectpicker" name="jenis" data-live-search="true">
                          <option>-Pilih-</option>
                          <option value="berkala">Informasi berkala</option>
                          <option value="serta_merta">Informasi serta merta</option>
                          <option value="setiap_saat">Informasi tersedia setiap saat</option>
                ...
                <div class="card-footer d-flex justify-content-end">
                    <button class="btn btn-danger " id="cancel"><span class="fa fa-arrow-left"></span> Back</button>&nbsp;&nbsp;
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
    $('#cancel').on('click', function(e){
        e.preventDefault();
        window.location = "<?php echo base_url('admin/download') ?>";
    });
