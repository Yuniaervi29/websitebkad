          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a class="btn btn-primary" href="<?php echo base_url('admin/tugas_pokok/add') ?>"><span class="fa fa-plus"></span> Tambah Data</a></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td align="center">
                        <a class="btn btn-info btn-sm" href="<?php echo base_url('admin/tugas_pokok/edit/'.$row->post_id) ?>">
                              <i class="fas fa-edit">
                              </i>
                              Edit
                          </a>
    ...
    function hapus(post_id){
          ...
          Swal.fire({
            ...
            if (result.value) {
              $.ajax({
                        type : "POST",
                        url  : "<?php echo site_url('admin/tugas_pokok/delete')?>",
                        dataType : "JSON",
                        ...
                        success: function(){
                          ...
                          Swal.fire(
                            ...
                            'success'
                              ...
                              if(value){
                                 location.href= '<?php echo site_url('admin/tugas_pokok')?>';
                              }
                          });
                        },error:function(){
