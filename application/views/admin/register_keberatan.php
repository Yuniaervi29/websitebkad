    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form  class="form-horizontal" id="form" method="post" action="<?=base_url('admin/proses_permohonan_informasi/update');?>">
				<div class="col-md-12">
			...
			<div id="form-group row">
				...
				<input type="text" id="rp_salin" name="rp_salin" placeholder="Harga" onkeyup="hitung();">&emsp;
				<input type="number" id="lembar" name="lembar" placeholder="Lembar" min="1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" onkeyup="hitung();">&emsp;
				<input type="text" id="total" name="total" placeholder="Total" readonly><br><br>
                  ...
                  <tbody>
                    ...
                    foreach($isi->result() as $row){
                        ...
                        <button class='btn btn-danger btn-sm' onclick='hapus($row->id)'>
                          ...
                          <a href='".base_url()."admin/proses_permohonan_informasi/cetak?no=$row->noreg' target='_blank' class='btn btn-primary'>
<span class='fa fa-print'></span> Print</a>
                        ...
                        <button class='btn btn-danger btn-sm' onclick='hapus($row->id)'>
                          ...
                          <a href='".base_url()."admin/proses_permohonan_informasi/cetak?no=$row->noreg' target='_blank' class='btn btn-primary disabled'>
<span class='fa fa-print'></span> Print</a>
                    </td>
                    </tr>";
                        }
