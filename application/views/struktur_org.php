						...
						<div class="bread-inner">
							...
							<div class="bread-menu">
								<ul>
									...
									<li><a href="blog-standard-sidebar.html">Struktur Organisasi</a></li>
								</ul>
							</div>
                            <!-- Bread Title -->
                            
							<div class="bread-title"><h2>Struktur Organisasi BKAD Prov. Sul-Sel</h2></div>
						</div>
					</div>
				</div>
			</div>
...
<section class="section-space" style="backgroun-color:grey;">
  <div class="container">
      <h3 class="text-center pb-5">Struktur Organisasi BKAD Prov. Sul-Sel</h3>
    <img src="assets/img/Group.png" alt="">
    <br>
    <br>
    <br>
    <br>
    <!--<a type="button" class="btn btn-primary" href="<?php echo base_url(); ?>profil/assets/img/Group.png; ?>"  target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Cetak</a>-->
  </div>
