...
class Kinerja extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_kinerja();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'KINERJA';
		$this->admin->view('admin/kinerja', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/kinerja_form', $output);
		}else
		{
