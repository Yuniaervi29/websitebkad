...
class Tujuan_sasaran extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_tujuan_sasaran();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'TUJUAN & SASARAN';
		$this->admin->view('admin/tujuan_sasaran', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/tujuan_sasaran_form', $output);
		}else
		{
