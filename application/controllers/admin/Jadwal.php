...
class Jadwal extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_jadwal();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'JADWAL & BIAYA PELAYANAN';
		$this->admin->view('admin/jadwal', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/jadwal_form', $output);
		}else
		{
