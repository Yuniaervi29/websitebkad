...
class Struktur_organisasi extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_struktur_organisasi();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'STRUKTUR ORGANISASI';
		$this->admin->view('admin/struktur_organisasi', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/struktur_organisasi_form', $output);
		}else
		{
			...
			$data['post_status']	= '';
			$data['post_type']		= 'struktur_organisasi';
