...
class Tugas_pokok extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_tugas_pokok();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'TUGAS POKOK & FUNGSI';
		$this->admin->view('admin/tugas_pokok', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/tugas_pokok_form', $output);
		}else
		{
