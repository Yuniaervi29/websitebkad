...
// 		$noreg = $this->uri->segment(3);
	...
	function get_data(){
	    $id = $this->input->post('id');
        $data = $this->db->select('id,noreg,tgl,nama,pekerjaan,alamat,email,hp,nik,rincian,tujuan,get_info,get_salinan_info')->from('inbox_permohonan_informasi')->where('id',$id)->get();
