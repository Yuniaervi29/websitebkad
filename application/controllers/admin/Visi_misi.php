...
class Visi_misi extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_visi_misi();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'VISI & MISI';
		$this->admin->view('admin/visi_misi', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/visi_misi_form', $output);
		}else
		{
