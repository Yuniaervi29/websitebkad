...
class Program_kerja extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_program_kerja();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'PROGRAM KERJA';
		$this->admin->view('admin/program_kerja', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/program_kerja_form', $output);
		}else
		{
