...
class Profil_ppid extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_profil_ppid();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'PROFIL PPID';
		$this->admin->view('admin/profil_ppid', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/profil_ppid_form', $output);
		}else
		{
