...
class Informasi_publik extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_informasi_publik();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'Daftar Informasi & Publik';
		$this->admin->view('admin/informasiPublik', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/informasiPublikForm', $output);
		}else
		{
			...
			$data['post_status']	= '';
			$data['post_type']		= 'informasi_publik';
