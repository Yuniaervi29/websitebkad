...
class Maklumat extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_maklumat();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'MAKLUMAT';
		$this->admin->view('admin/maklumat', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/maklumat_form', $output);
		}else
		{
