...
class Struktur_ppid extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_struktur_ppid();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'STRUKTUR ORGANISASI PPID';
		$this->admin->view('admin/struktur_ppid', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/struktur_ppid_form', $output);
		}else
		{
