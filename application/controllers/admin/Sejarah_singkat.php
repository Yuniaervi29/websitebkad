...
class Sejarah_singkat extends CI_Controller {
	...
	function index()
	{
        $post = $this->post_model->get_sejarah_singkat();
        $output['POST'] = $post['result'];
		$output['PAGE_TITLE'] = 'SEJARAH SINGKAT';
		$this->admin->view('admin/sejarah_singkat', $output);
    }
    ...
    function add()
	{
        if (!isset($_POST['post_title']))
		{
		    ...
		    $this->admin->view('admin/sejarah_singkat_form', $output);
		}else
		{
			...
			$data['post_status']	= '';
			$data['post_type']		= 'sejarah_singkat';
